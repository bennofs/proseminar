...
\begin{frame}\frametitle{Related Work}
  \begin{itemize}
    ...
    \item Linux modular scheduling framework
  \end{itemize}
...
\begin{frame}\frametitle{Real-time Tasks}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=-6cm, yshift=1.5cm]
      \clip (-0.2,0) rectangle (11,3);
      \alt<2->{
        \clip (-0.2,0) rectangle (5.9*\taskunit,3);
      }{
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=-6cm, yshift=1.5cm]
      ...
      \begin{scope}[yshift=2cm]
        ...
        \only<3>{\task{active}{brew}{4.5}{1.75}};
        \taskstart;
        \only<2>{
...
\begin{frame}[fragile]\frametitle{API, multicore, shared resources}
